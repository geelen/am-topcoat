...
.topcoat-icon-button--quiet
    @extend .topcoat-icon-button
    /*button--quiet()*/

.topcoat-icon-button--quiet:disabled
    @extend .topcoat-icon-button:disabled

.topcoat-icon-button--quiet:hover
  @extend .topcoat-icon-button:hover
  text-shadow: var-text-shadow;
  border: var-border;
  box-shadow: var-box-shadow;

.topcoat-icon-button--quiet:focus, .topcoat-icon-button--quiet:hover:focus
  @extend .topcoat-icon-button:focus

.topcoat-icon-button--quiet:active, .topcoat-icon-button--quiet:focus:active
    color var-color
    text-shadow var-text-shadow
    background-color var-background-color--down
    border var-border
...
.topcoat-icon-button--large:active
  @extend .topcoat-icon-button:active
...
.topcoat-icon-button--large--quiet
  @extend .topcoat-icon-button--large
  button--quiet()
...
.topcoat-icon-button--large--quiet:hover
  @extend .topcoat-icon-button--quiet:hover

.topcoat-icon-button--large--quiet:focus, .topcoat-icon-button--large--quiet:hover:focus
  @extend .topcoat-icon-button:focus

.topcoat-icon-button--large--quiet:active, .topcoat-icon-button--large--quiet:focus:active
  @extend .topcoat-icon-button--quiet:active
